...
namespace Persistence.Migrations
{
    ...
    [Migration("20230407215039_appBGTasks")]
    partial class appBGTasks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AppBackgroundTasks.AppBackgroundTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBackgroundTasks");
                });

            modelBuilder.Entity("Domain.AppConfiguration.AppConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Compound", b =>
                {
                    ...
                    b.Property<string>("CanonicalSmile")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MolAreaUnit")
                        .HasColumnType("text");

                    b.Property<string>("MolFormula")
                        .HasColumnType("text");

                    b.Property<string>("MolLogP")
                        .HasColumnType("text");

                    b.Property<string>("MolVolume")
                        .HasColumnType("text");

                    b.Property<string>("MolVolumeUnit")
                        .HasColumnType("text");

                    b.Property<string>("MolWeight")
                        .HasColumnType("text");

                    b.Property<string>("MolWeightUnit")
                        .HasColumnType("text");

                    b.Property<string>("PubChemRef")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.GenePublicData", b =>
                {
                    ...
                    b.Property<string>("GeneLengthUnit")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("IsoelectricPointUnit")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MolecularMassUnit")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ProteinLengthUnit")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.GeneVulnerability", b =>
                {
                    ...
                    b.Property<string>("HighConfidenceVulnerabilityCall")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Project", b =>
                {
                    ...
                    b.Property<string>("ProjectLegacyId")
                        .HasColumnType("text");
